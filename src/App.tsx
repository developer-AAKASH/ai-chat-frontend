...
export default function App() {
  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-surface text-slate-100">
      {/* Desktop sidebar */}
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-white/5 px-3 py-2.5 sm:px-4">
          <button
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-sm font-semibold tracking-wide text-slate-100 sm:text-base">
              Aria
            </span>
          </div>

          <nav className="ml-auto flex items-center gap-1 rounded-xl bg-surface-muted p-1">
